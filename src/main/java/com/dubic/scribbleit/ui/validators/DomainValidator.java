 ...
 * href="http://www.ietf.org/rfc/rfc1123.txt">RFC1123</a>, section 2.1. No accomodation is provided
 ...
 * </ul>
 * <p>
 * (<b>NOTE</b>: This class does not provide IP address lookup for domain names or methods to ensure
 * that a given domain name matches a specific IP; see {@link java.net.InetAddress} for that
 * functionality.)
 * </p>
 *
...
public class DomainValidator implements Serializable {
   ...
   * <code>String</code> parses as a valid domain name with a recognized top-level domain. The
  ...
  /**
   * Returns true if the specified
   * <code>String</code> matches any IANA-defined top-level domain. Leading dots are ignored if
  ...
  /**
   * Returns true if the specified
   * <code>String</code> matches any IANA-defined infrastructure top-level domain. Leading dots are
  ...
  /**
   * Returns true if the specified
   * <code>String</code> matches any IANA-defined generic top-level domain. Leading dots are ignored
  ...
  /**
   * Returns true if the specified
   * <code>String</code> matches any IANA-defined country code top-level domain. Leading dots are
   * ignored if present. The search is case-sensitive.
   *
  ...
  /**
   * Returns true if the specified
   * <code>String</code> matches any widely used "local" domains (localhost or localdomain). Leading
  ...
  private static final String[] COUNTRY_CODE_TLDS = new String[]{"ac", // Ascension
    ...
    "as", // American Samoa
    "at", // Austria
    "au", // Australia (includes Ashmore and Cartier Islands and Coral Sea
    // Islands)
    "aw", // Aruba
    "ax", // �land
    "az", // Azerbaijan
    ...
    "ky", // Cayman Islands
    "kz", // Kazakhstan
    "la", // Laos (currently being marketed as the official domain for Los
    // Angeles)
    "lb", // Lebanon
    "lc", // Saint Lucia
    "li", // Liechtenstein
