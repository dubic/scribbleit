 ...
 * </p>
 * Behavior of validation is modified by passing in options: <li>ALLOW_2_SLASHES - [FALSE] Allows
 * double '/' characters in the path component.</li> <li>
 * NO_FRAGMENT- [FALSE] By default fragments are allowed, if this option is included then fragments
 * are flagged as illegal.</li> <li>ALLOW_ALL_SCHEMES - [FALSE] By default only http, https, and ftp
 * are considered valid schemes. Enabling this option will let any scheme pass validation.</li>
 * <p>
...
public class UrlValidator implements Serializable {
   ...
   * default to "http,https,ftp" being valid. If a non-null schemes is specified then all valid
   * schemes must be specified. Setting the ALLOW_ALL_SCHEMES option will ignore the contents of
   * schemes.
   */
   ...
   * set multiple options you simply add them together. For example, ALLOW_2_SLASHES + NO_FRAGMENTS
   * enables both of those options.
   * @param s added just to make Netbeans happy. He thinks the constructor call in this(String[]) is
   * ambiguous.
   */
  public UrlValidator(String[] schemes, long options, String s) {
   ...
   * hostname and port. A
   * <code>null</code> authority value is considered invalid.
   *
  ...
  /**
   * Returns true if the path is valid. A
