 ...
 */
package com.dubic.scribbleit.db;
...
//            log.debug(String.format("merged [%s]", t));
    ...
    /**
     * returns an entity using em.find.does not throw exception if no entity is
     * found
     *
     * @param <T>
    ...
    /**
     * returns an entity using em.find and throws exception if no entity is
     * found
     *
     * @param <T>
     ...
     * entity manager from other classes usage
     *
     * @param <T>
     * @param namedQuery
     * @param tClass
    ...
    /**
     * creates a simple query from the query string and type class.abstracts
     * entity manager from other classes
     *
     * @param <T>
    ...
    /**
     * creates a native query from the query string and type class.abstracts
     * entity manager from other classes
     *
     * @param <T>
    ...
    /**
     * creates a query from query string passed.query is paginated with the page
     * and step
     *
     * @param query
     * @param page
