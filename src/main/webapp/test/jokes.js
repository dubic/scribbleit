...
$(function() {
    ...
    $.getJSON("/scribbleit/testapi/jokes", function(posts) {
...
function createJoke(post) {
    ...
    var commentBlock = $('<div class="row comment"></div>')
            .append($('<div class="col-md-1"></div>')
                    .append($('<img class="poster-img" width="40" height="40"/>').attr('src', '/scribbleit/test/img/femi.jpg')))
            .append($('<div class="col-md-10"></div>')
                    .append($('<div class="row"></div>')
...
function updatePosted(post) {
    $('#post-list').append(createJoke(post));
}
